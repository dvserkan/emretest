...
>(({ className, children, onClose, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-background/90 data-[state=active]:text-foreground data-[state=active]:shadow-sm data-[state=active]:border-b-2 data-[state=active]:border-primary",
      "data-[state=active]:backdrop-blur-sm hover:bg-background/60 hover:shadow-sm hover:border-b-2 hover:border-primary/50",
      className
    )}
    {...props}
  >
